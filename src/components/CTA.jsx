      ...
      <div className={`container ${styles.container}`}>
        ...
        <div className={`${styles.directContact} reveal fade-in delay-200`}>
          <div className={styles.contactItem}>
            ...
            <a href="mailto:kontakt@webbroskidev.pl" className={styles.contactLink}>kontakt@webbroskidev.pl</a>
          </div>
          
          <div className={styles.contactItem}>
            <span className={styles.contactLabel}>Zadzwoń do mnie:</span>
            <a href="tel:+48600176361" className={styles.contactLink}>+48 600 176 361</a>
          </div>
